...
<head>
    ...
    @vite(['resources/scss/admin/admindashboard.scss', 'resources/scss/sidebar.scss', 'resources/scss/footer.scss', 'resources/js/sidebar.js', 'resources/js/admin/dashboard.js'])
</head>
<body>
    <main>
        <div class="wrapper">
